...
lean_lib «SpencerRoute» where
  roots := #[`examples.«magic-squares».spencer.Spencer,
             ...
             `examples.«magic-squares».spencer.DoublyStochasticSupport,
             `examples.«magic-squares».spencer.SemiMagicCone,
             `examples.«magic-squares».spencer.OrthantFaceOrder,
             `examples.«magic-squares».spencer.SemiMagicFaceSupport,
             `examples.«magic-squares».spencer.SupportedSubtypeSum,
             `examples.«magic-squares».spencer.FiniteMobiusWeights,
             `examples.«magic-squares».spencer.FiniteMobiusTransport,
             `examples.«magic-squares».spencer.MatchingMobius,
             `examples.«magic-squares».spencer.SemiMagicFaceMobius,
             `examples.«magic-squares».spencer.ClosedIntervalIndicator,
             `examples.«magic-squares».spencer.ClosedIntervalValuation,
             `examples.«magic-squares».spencer.CompactRealValuation,
             `examples.«magic-squares».spencer.CompactConvexProjection,
             `examples.«magic-squares».spencer.CompactConvexValuation,
             `examples.«magic-squares».spencer.PerspectiveBoundary,
             `examples.«magic-squares».spencer.PerspectiveCoverage,
             `examples.«magic-squares».spencer.PerspectiveCompact,
             `examples.«magic-squares».spencer.PerspectiveShadow,
             `examples.«magic-squares».spencer.PerspectiveIntersections,
             `examples.«magic-squares».spencer.PerspectiveCancellation,
             `examples.«magic-squares».spencer.FiniteCoordinateValuation,
             `examples.«magic-squares».spencer.PerspectiveExternalPoint,
             `examples.«magic-squares».spencer.SupportExtensionCancellation,
             `examples.«magic-squares».spencer.MatchingIntervalEuler,
             `examples.«magic-squares».spencer.MissionVCompleted,
             `examples.«magic-squares».spencer.ClosedIntervalEuler,
             `examples.«magic-squares».spencer.CompactConvexSlices,
             `examples.«magic-squares».spencer.CompactConvexRepresentation,
             `examples.«magic-squares».spencer.PerspectiveConvex,
             `examples.«magic-squares».spencer.FiniteCoverIndicator,
